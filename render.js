...
function bankChip(x, y, bank){
  return `
    <g transform="translate(${x},${y})">
      ...
      <text x="18" y="6" text-anchor="start" font-family="Poppins" font-weight="400" font-size="25" fill="#F5F1E8">${bank.name}</text>
    </g>`;
}
...
<svg xmlns="http://www.w3.org/2000/svg" width="1080" height="1080" viewBox="0 0 1080 1080">
  ...
  <text x="540" y="182" text-anchor="middle" font-family="Poppins" font-weight="700" font-size="63" letter-spacing="7" fill="url(#goldFoil)">ANUAR</text>
  <line x1="410" y1="212" x2="470" y2="212" stroke="url(#goldLine)" stroke-width="1.5"/>
  <text x="540" y="220" text-anchor="middle" font-family="Poppins" font-weight="500" font-size="21" letter-spacing="10" fill="#F5F1E8">NYSE</text>
  ...
  <text x="540" y="330" text-anchor="middle" font-family="Lora" font-style="italic" font-weight="500" font-size="27" letter-spacing="2" fill="#C9A227">Cotización · ${dateStr}</text>
  ...
  <g transform="translate(540,470)">
    ...
    <text x="-160" y="0" text-anchor="middle" font-family="Poppins" font-weight="700" font-size="69" fill="url(#goldFoil)">${rateStr}</text>
    <text x="0" y="-2" text-anchor="middle" font-family="Poppins" font-weight="600" font-size="41" fill="#8a7550">=</text>
    <text x="165" y="0" text-anchor="middle" font-family="Poppins" font-weight="700" font-size="69" fill="#F5F1E8">1 USD</text>
  ...
  <g transform="translate(540,590)">
    ...
    <text x="0" y="7" text-anchor="middle" font-family="Poppins" font-weight="600" font-size="25" letter-spacing="6" fill="#E8C468">SIN COMISIONES</text>
  </g>` : ``}
  ...
  <text x="540" y="700" text-anchor="middle" font-family="Poppins" font-weight="500" font-size="27" fill="#F5F1E8">Transferimos a CVU / CBU.</text>
  <text x="540" y="734" text-anchor="middle" font-family="Poppins" font-weight="500" font-size="27" fill="#F5F1E8">Billeteras Virtuales y Bancos.</text>

  <text x="540" y="776" text-anchor="middle" font-family="Lora" font-style="italic" font-weight="500" font-size="23" letter-spacing="2" fill="#C9A227">Recibimos en Ecuador en los bancos</text>
  ...
  <text x="540" y="962" text-anchor="middle" font-family="Poppins" font-weight="500" font-size="22" letter-spacing="5" fill="#C9A227">SEGUI NUESTRAS COTIZACIONES DIARIAS</text>
</svg>`;
}
