...
<svg xmlns="http://www.w3.org/2000/svg" width="1080" height="1080" viewBox="0 0 1080 1080">
  ...
  <g transform="translate(540,470)">
    ...
    <text x="-160" y="-54" text-anchor="middle" font-family="Poppins" font-weight="600" font-size="17" letter-spacing="5" fill="#C9A227">COMPRA</text>
    <text x="-160" y="6" text-anchor="middle" font-family="Poppins" font-weight="700" font-size="64" fill="url(#goldFoil)">${rateStr}</text>
    <text x="0" y="4" text-anchor="middle" font-family="Poppins" font-weight="600" font-size="38" fill="#8a7550">/</text>
    <text x="165" y="-54" text-anchor="middle" font-family="Poppins" font-weight="600" font-size="17" letter-spacing="5" fill="#C9A227">VENTA</text>
    <text x="165" y="6" text-anchor="middle" font-family="Poppins" font-weight="700" font-size="64" fill="#F5F1E8">${ventaStr}</text>
